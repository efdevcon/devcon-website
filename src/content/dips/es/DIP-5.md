...
- hacer pública la lista de claves públicas precargadas en el Keycard Cash Applet de cada tarjeta. Ver https://keycard.tech/docs/sdk/cash.html y https://keycard.tech/docs/web3.html
