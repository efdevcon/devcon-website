...
export default function Components() {
  ...
  return (
    <div>
        ...
        <Link to='https://www.devcon.org/' indicateExternal>External Link with Icon</Link> <br/>
        <br/>

        <h2>Modal</h2>
        <span role="button" onClick={() => setModalOpen(true)}>Click to open Modal</span>
        <Modal 
          open={modalOpen}
        ...
        <Tabs>
          <Tab title='Tab #1'>
            <div>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus commodo leo nec urna faucibus, sed luctus arcu tristique. Maecenas vitae nunc purus. Proin ut nisl commodo, venenatis lacus eu, lobortis ligula. Nam felis justo, vulputate nec tempus porta, placerat sit amet augue.</p>
            </div>
          </Tab>
          <Tab title='Tab #2'>
            <div>
              <p>Maecenas semper lacus ut est egestas lacinia. Vestibulum mattis porttitor felis in cursus. Pellentesque sed elit sed nulla molestie condimentum at ut erat. Ut suscipit magna in ante commodo, vel fermentum sapien iaculis. Sed porta nibh in tortor eleifend convallis.</p>
              <p>Maecenas luctus, metus vitae semper fringilla, felis nisl commodo leo, vel feugiat justo purus quis turpis. Vestibulum id mollis diam, non condimentum tellus.</p>
            </div>
          </Tab>
        </Tabs>
        <br/>
