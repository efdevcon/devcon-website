        ...
        <div className={props.className ?? ''}>
            ...
            {props.section.body &&
                <div className="clear-bottom border-bottom">
                    <div
                        className="markdown"
                        dangerouslySetInnerHTML={{ __html: toHtml(props.section.body) }}
                    />
                </div>
            }
            {(props.section.data.left || props.section.data.right) &&
                <div className="two-columns clear-bottom border-bottom">
                    <div className="left section-markdown">
                        <div
                            className="markdown"
                            dangerouslySetInnerHTML={{ __html: toHtml(props.section.data.left) }}
                        />
                    </div>
                    <div className="right">
                        <div
                            className="markdown"
                            dangerouslySetInnerHTML={{ __html: toHtml(props.section.data.right) }}
                        />
                    </div>
                </div>
            }
