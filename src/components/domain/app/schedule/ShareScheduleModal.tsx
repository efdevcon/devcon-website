        ...
        <>
            <Modal className={css['modal']} open={infoOpen} close={() => setInfoOpen(false)} unstyled noIcon>
                ...
                <div className={css['link']}>
                    <input type='text' className={css['input']} value={scheduleUri} readOnly disabled={!accountContext.account?.appState?.publicSchedule} />
                ...
                <p>Go to <Link to ='/app/settings#account'>settings</Link> if you want to configure your account and profile.</p>
            </Modal>
